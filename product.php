             ...
             <?php echo '<img src="data:image/jpeg;base64,'.$volunteering->img.'" height="300"/>'; ?>
               <div class="down-content" style="direction: rtl;">
                 <h4><?php echo $volunteering->name?></h4>
                  <hr>
                 <p>
                  <?php echo $volunteering->price;?> د.ل
                </p>
                <form id="contact" action="product_res.php" method="post" >
                  <input  type="number" name="id_product" value="<?php echo $volunteering->id_product;?>" hidden>

                  <button name="insert_product_res" value="insert_product_res" type="submit" style="color: #ffa5d2;border: 0px;background-color: white;">حجر الآن <i class="fa fa-angle-double-up"></i></button>
